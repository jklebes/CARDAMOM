...
## about you (needed when running on remote computer, e.g. Eddie)
...
## Language
# i.e. "Fortran", "C"
language="Fortran" # currently only Fortran maintained
...
deforestation_source=" "   # " ", "site_specific", "GFW"
# Obserations timeseries
lai_source="site_specific"   # "MODIS" or "COPERNICUS" or "site_specific"
soilwater_initial_source = "GLEAM" # " ", "site_specific", "GLEAM"
