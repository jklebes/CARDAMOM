...
! Subroutine to allow direct interface between DALEC.A1.C2.D2.F2.H2.P10.R2 and the R code
!
! Author: T. Luke Smallman (02/05/2024)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

subroutine rdalec26(output_dim,aNPP_dim,MTT_dim,SS_dim,met,pars &
