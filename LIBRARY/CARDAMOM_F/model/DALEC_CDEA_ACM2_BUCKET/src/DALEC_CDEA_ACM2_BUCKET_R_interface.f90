...
subroutine rdaleccdeaacm2bucket(output_dim,MTT_dim,SS_dim &
                               ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,54) = gs_total_canopy             ! stomatal conductance (mmolH2O/m2ground/s)
     out_var1(i,1:nodays,55) = canopy_par_MJday_time       ! Canopy absorbed PAR (MJ/m2ground/day)
     out_var1(i,1:nodays,56) = gb_total_canopy             ! boundary conductance (mmolH2O/m2ground/s)
