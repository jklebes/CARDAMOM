...
int EDC1_LU_FIRES_ET(double const pars[], struct EDCDIAGNOSTIC *EDCD, double meantemp, double meanrad)
{
...
int EDC2_LU_FIRES_ET(double const pars[], double *MET, double *LAI, double *NEE, double *POOLS,double *FLUXES, PARAMETER_INFO PI, DATA D, struct EDCDIAGNOSTIC *EDCD, double meantemp)
{
