...
# Interface needs updating
    ...
    rm(output,MTT_years,SS_gCm2)
      ...
      output_dim = 77 ; MTT_dim = 6 ; SS_dim = 6
      dyn.load(paste(PROJECT$exepath,"/dalec.so", sep=""))
      ...
      states_all=list(# Ecosystem fluxes
                      ...
                      mean_FIRElitter_litter_gCm2day = output_mean[,26],
                      mean_annual_FIRElitter_litter_gCm2day = output_annual[,,26],
                      FIREemiss_som_gCm2day = output[,,27],
                      mean_FIREemiss_som_gCm2day = output_mean[,27],
                      mean_annual_FIREemiss_som_gCm2day = output_annual[,,27],
                      HARVESTextracted_labile_gCm2day = output[,,28],
                      mean_HARVESTextracted_labile_gCm2day = output_mean[,28],
                      mean_annual_HARVESTextracted_labile_gCm2day = output_annual[,,28],
                      HARVESTextracted_foliage_gCm2day = output[,,29],
                      mean_HARVESTextracted_foliage_gCm2day = output_mean[,29],
                      mean_annual_HARVESTextracted_foliage_gCm2day = output_annual[,,29],
                      HARVESTextracted_roots_gCm2day = output[,,30],
                      mean_HARVESTextracted_roots_gCm2day = output_mean[,30],
                      mean_annual_HARVESTextracted_roots_gCm2day = output_annual[,,30],
                      HARVESTextracted_wood_gCm2day = output[,,31],
                      mean_HARVESTextracted_wood_gCm2day = output_mean[,31],
                      mean_annual_HARVESTextracted_wood_gCm2day = output_annual[,,31],
                      HARVESTextracted_litter_gCm2day = output[,,32],
                      mean_HARVESTextracted_litter_gCm2day = output_mean[,32],
                      mean_annual_HARVESTextracted_litter_gCm2day = output_annual[,,32],
                      HARVESTextracted_som_gCm2day = output[,,33],
                      mean_HARVESTextracted_som_gCm2day = output_mean[,33],
                      mean_annual_HARVESTextracted_som_gCm2day = output_annual[,,33],
                      HARVESTlitter_labile_gCm2day = output[,,34],
                      mean_HARVESTlitter_labile_gCm2day = output_mean[,34],
                      mean_annual_HARVESTlitter_labile_gCm2day = output_annual[,,34],
                      HARVESTlitter_foliage_gCm2day = output[,,35],
                      mean_HARVESTlitter_foliage_gCm2day = output_mean[,35],
                      mean_annual_HARVESTlitter_foliage_gCm2day = output_annual[,,35],
                      HARVESTlitter_roots_gCm2day = output[,,36],
                      mean_HARVESTlitter_roots_gCm2day = output_mean[,36],
                      mean_annual_HARVESTlitter_roots_gCm2day = output_annual[,,36],
                      HARVESTlitter_wood_gCm2day = output[,,37],
                      mean_HARVESTlitter_wood_gCm2day = output_mean[,37],
                      mean_annual_HARVESTlitter_wood_gCm2day = output_annual[,,37],
                      # C pools (gC/m2)
                      labile_gCm2 = output[,,38],
                      mean_labile_gCm2 = output_mean[,38],
                      mean_annual_labile_gCm2 = output_annual[,,38],
                      foliage_gCm2 = output[,,39],
                      mean_foliage_gCm2 = output_mean[,39],
                      mean_annual_foliage_gCm2 = output_annual[,,39],
                      roots_gCm2 = output[,,40],
                      mean_roots_gCm2 = output_mean[,40],
                      mean_annual_roots_gCm2 = output_annual[,,40],
                      wood_gCm2 = output[,,41],
                      mean_wood_gCm2 = output_mean[,41],
                      mean_annual_wood_gCm2 = output_annual[,,41],
                      ...
                      # Water cycle related
                      ET_kgH2Om2day = output[,,44],
                      mean_ET_kgH2Om2day = output_mean[,44],
                      mean_annual_ET_kgH2Om2day = output_annual[,,44],
                      Etrans_kgH2Om2day = output[,,45],
                      mean_Etrans_kgH2Om2day = output_mean[,45],
                      mean_annual_Etrans_kgH2Om2day = output_annual[,,45],
                      Esoil_kgH2Om2day = output[,,46],
                      mean_Esoil_kgH2Om2day = output_mean[,46],
                      mean_annual_Esoil_kgH2Om2day = output_annual[,,46],
                      Ewetcanopy_kgH2Om2day = output[,,47],
                      mean_Ewetcanopy_kgH2Om2day = output_mean[,47],
                      mean_annual_Ewetcanopy_kgH2Om2day = output_annual[,,47],
                      runoff_kgH2Om2day = output[,,48],
                      mean_runoff_kgH2Om2day = output_mean[,48],
                      mean_annual_runoff_kgH2Om2day = output_annual[,,48],
                      underflow_kgH2Om2day = output[,,49],
                      mean_underflow_kgH2Om2day = output_mean[,49],
                      mean_annual_underflow_kgH2Om2day = output_annual[,,49],
                      SurfDrainage_kgH2Om2day = output[,,50],
                      mean_SurfDrainage_kgH2Om2day = output_mean[,50],
                      mean_annual_SurfDrainage_kgH2Om2day = output_annual[,,50],
                      SurfInfiltrated_kgH2Om2day = output[,,51],
                      mean_SurfInfiltrated_kgH2Om2day = output_mean[,51],
                      mean_annual_SurfInfiltrated_kgH2Om2day = output_annual[,,51],
                      Etrans_1st_root_layer_uptake_fraction = output[,,52],
                      mean_Etrans_1st_root_layer_uptake_fraction = output_mean[,52],
                      mean_annual_Etrans_1st_root_layer_uptake_fraction = output_annual[,,52],
                      Etrans_2nd_root_layer_uptake_fraction = output[,,53],
                      mean_Etrans_2nd_root_layer_uptake_fraction = output_mean[,53],
                      mean_annual_Etrans_2nd_root_layer_uptake_fraction = output_annual[,,53],
                      SurfWater_kgH2Om2 = output[,,54],
                      mean_SurfWater_kgH2Om2 = output_mean[,54],
                      mean_annual_SurfWater_kgH2Om2 = output_annual[,,54],
                      wSWP_MPa = output[,,55],
                      mean_wSWP_MPa = output_mean[,55],
                      mean_annual_wSWP_MPa = output_annual[,,55],
                      snow_kgH2Om2 = output[,,56],
                      mean_snow_kgH2Om2 = output_mean[,56],
                      mean_annual_snow_kgH2Om2 = output_annual[,,56],
                      # Canopy (phenology) properties
                      lai_m2m2 = output[,,57],
                      mean_lai_m2m2 = output_mean[,57],
                      mean_annual_lai_m2m2 = output_annual[,,57],
                      # Photosynthesis / C~water coupling related
                      gs_demand_supply_ratio = output[,,58],
                      mean_gs_demand_supply_ratio = output_mean[,58],
                      mean_annual_gs_demand_supply_ratio = output_annual[,,58],
                      gs_mmolH2Om2s = output[,,59],
                      mean_gs_mmolH2Om2s = output_mean[,59],
                      mean_annual_gs_mmolH2Om2s = output_annual[,,59],
                      APAR_MJm2day = output[,,60],
                      mean_APAR_MJm2day = output_mean[,60],
                      mean_annual_APAR_MJm2day = output_annual[,,60],
                      gb_mmolH2Om2s = output[,,61],
                      mean_gb_mmolH2Om2s = output_mean[,61],
                      mean_annual_gb_mmolH2Om2s = output_annual[,,61],
                      CiCa = output[,,62],
                      mean_CiCa = output_mean[,62],
                      mean_annual_CiCa = output_annual[,,62],
                      # Misc
                      RootDepth_m = output[,,63],
                      mean_RootDepth_m = output_mean[,63],
                      mean_annual_RootDepth_m = output_annual[,,63],
                      leaf_temperature_celcius = output[,,64],
                      mean_leaf_temperature_celcius = output_mean[,64],
                      mean_annual_leaf_temperature_celcius = output_annual[,,64],                      
                      soil_temperature_celcius = output[,,65],
                      mean_soil_temperature_celcius = output_mean[,65],
                      mean_annual_soil_temperature_celcius = output_annual[,,65],   
                      # Plant water stress
                      LWP_MPa = output[,,66],
                      mean_LWP_MPa = output_mean[,66],
                      mean_annual_LWP_MPa = output_annual[,,66],
                      # C allocation diagnositics
                      LabBio_limitation = output[,,67],
                      mean_LabBio_limitation = output_mean[,67],
                      mean_annual_LabBio_limitation = output_annual[,,67],
                      foliage_leafT_limitation = output[,,68],
                      mean_foliage_leafT_limitation = output_mean[,68],
                      mean_annual_foliage_leafT_limitation = output_annual[,,68],
                      roots_leafT_limitation = output[,,69],
                      mean_roots_leafT_limitation = output_mean[,69],
                      mean_annual_roots_leafT_limitation = output_annual[,,69],
                      wood_leafT_limitation = output[,,70],
                      mean_wood_leafT_limitation = output_mean[,70],
                      mean_annual_wood_leafT_limitation = output_annual[,,70],
                      foliage_wSWP_limitation = output[,,71],
                      mean_foliage_wSWP_limitation = output_mean[,71],
                      mean_annual_foliage_wSWP_limitation = output_annual[,,71],
                      roots_wSWP_limitation = output[,,72],
                      mean_roots_wSWP_limitation = output_mean[,72],
                      mean_annual_roots_wSWP_limitation = output_annual[,,72],
                      wood_wSWP_limitation = output[,,73],
                      mean_wood_wSWP_limitation = output_mean[,73],
                      mean_annual_wood_wSWP_limitation = output_annual[,,73],
                      gpp_return_gCm2day = output[,,74],
                      mean_gpp_return_gCm2day = output_mean[,74],
                      mean_annual_gpp_return_gCm2day = output_annual[,,74],
                      canopy_area_scaling_wind = output[,,75],
                      mean_canopy_area_scaling_wind = output_mean[,75],
                      mean_annual_canopy_area_scaling_wind = output_annual[,,75],
                      canopy_area_scaling_light = output[,,76],
                      mean_canopy_area_scaling_light = output_mean[,76],
                      mean_annual_canopy_area_scaling_light = output_annual[,,76],                      
                      foliar_loss_limitation = output[,,77],
                      mean_foliar_loss_limitation = output_mean[,77],
                      mean_annual_foliar_loss_limitation = output_annual[,,77], 
                      ## Aggregated variables
                      # Mean Transit times
                      MTT_labile_years = MTT_years[,1],
                      MTT_foliage_years = MTT_years[,2],
