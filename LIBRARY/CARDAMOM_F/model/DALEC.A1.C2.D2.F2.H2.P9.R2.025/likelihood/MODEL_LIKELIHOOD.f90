...
! of DALEC.A1.C2.D2.F2.H2.P9.R2 as a function of observations and ecological dynamical constraints.
  !
...
!    endif
  ...
  subroutine model_likelihood(PARS, npars, ML_obs_out,ML_prior_out)
    ! use model_shared, only: PI ! not where the data parinfo, npars is kept anymore
    use CARBON_MODEL_MOD, only: carbon_model
    use cardamom_structures, only: DATAin
