...
subroutine rdaleccdeaacm2bucketrmrgcwdwmrt(output_dim,MTT_dim,SS_dim &
                               ,met,pars &
...
!endif
     ...
     out_var1(i,1:nodays,6)  = FLUXES(1:nodays,45)      ! harvested material (gC/m2/day)
     ...
     ! misc
     out_var1(i,1:nodays,52) = root_depth_time          ! rooting depth (m)
