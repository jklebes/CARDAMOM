...
###
## Function to load met data from MPI forest biomass map (Thurner et al., 2014)
###

load_mpi_biomass_fields_for_extraction<-function(latlon_in,Cwood_source,Cwood_initial_source,start,finish,timestep_days) {
