...
cardamom_model_details <-function(modelname,specific_pft,ctessel_pft) {
  ...
  if (modelname == "ACM") {
    ...
    cardamom_model_details=list(name="DALEC.C3.M1.014",shortname="DALEC.14.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.A3.C3.H2.M1.015",shortname="DALEC.15.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.M2.016",shortname="DALEC.16.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.A3.H2.M2.017",shortname="DALEC.17.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.C1.D1.F2.P1.002",shortname="DALEC.2.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(28,dim=c(length(ctessel_pft)))
    nofluxes=array(39,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H1.P1.003", shortname="DALEC.3.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H2.P1.004",shortname="DALEC.4.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(32,dim=c(length(ctessel_pft)))
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A2.C1.D2.F2.H2.P1.020",shortname="DALEC.20.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    # Number of model parameters to be optimised
    nopools=array(7,dim=c(length(ctessel_pft)))
    nopars=array(42+1,dim=c(length(ctessel_pft)))
    nofluxes=array(56,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A4.C6.D2.F2.H2.P11.031",shortname="DALEC.31.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H2.P2.018",shortname="DALEC.18.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(33,dim=c(length(ctessel_pft)))
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H2.P5.021",shortname="DALEC.21.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(34,dim=c(length(ctessel_pft)))
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H2.P6.022",shortname="DALEC.22.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(32,dim=c(length(ctessel_pft)))
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H2.P1.R1.005",shortname="DALEC.5.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P1.R1.06",shortname="DALEC.6.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nofluxes=array(54,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P2.R1.007",shortname="DALEC.7.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(38,dim=c(length(ctessel_pft)))
    nofluxes=array(54,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P2.R3.019", shortname="DALEC.19.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.C5.D1.F2.P1.013",shortname="DALEC.13.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.D1.F2.001",shortname = "DALEC.1.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.C4.D1.F2.012",shortname = "DALEC.12.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H1.P4.R2.010",shortname = "DALEC.10.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P4.R2.011", shortname="DALEC.11.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(48,dim=c(length(ctessel_pft)))
    nofluxes=array(54,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P7.R2.023",shortname="DALEC.23.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nofluxes=array(54,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P8.R2.024",shortname="DALEC.24.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(49,dim=c(length(ctessel_pft)))
    nofluxes=array(54,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P9.R2.025",shortname="DALEC.25.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(48,dim=c(length(ctessel_pft)))
    nofluxes=array(34,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P10.R2.026",shortname="DALEC.26.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nofluxes=array(34,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H2.P3.R1.009",shortname = "DALEC9.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nofluxes=array(25,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C2.D2.F2.H1.P3.R1.008",shortname = "DALEC.8.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nopars=array(33,dim=c(length(ctessel_pft)))
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A1.C1.D2.F2.H3.P1.029",shortname="DALEC.29.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
    ...
    nofluxes=array(49,dim=c(length(ctessel_pft)))
    cardamom_model_details=list(name="DALEC.A3.C1.D2.F2.H2.P1.030",shortname="DALEC.30.",nopools=nopools,nofluxes=nofluxes,nomet=16,nopars=nopars)
  } else {
