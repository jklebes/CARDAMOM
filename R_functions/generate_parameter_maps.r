...
generate_parameter_maps<-function(PROJECT) {
  ...
  if (file.exists(outfile) == FALSE | repair == 1) {
      ...
      if (PROJECT$model$name == "DALEC_CDEA_LU_FIRES" | PROJECT$model$name == "DALEC_GSI_DFOL_FR" | 
          ...
          if (PROJECT$model$name == "DALEC_GSI_DFOL_CWD_FR") {
              ...
              par_array_median_normalised=par_array_median[,,-c(initial_conditions,24,28,29,30,31,32,33)]
  ...
  if (PROJECT$model$name == "DALEC_GSI_DFOL_CWD_FR" | PROJECT$model$name == "DALEC_BUCKET" 
    ...
    | PROJECT$model$name == "DALECN_BUCKET") {
      ...
      par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
      image.plot(resid_time_array_median[,,5], col=colour_choices, main=paste("CDeadOrg residence time median estimate",sep="")
  ...
  par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
  image.plot(resid_time_array_unc[,,1], col=colour_choices, main=paste("Cfoliar residence time uncertainty",sep="")
            ,axes=FALSE, cex.main=2.4,legend.width=3.0,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1),zlim=c(0,quantile(as.vector(resid_time_array_unc[,,1]),prob=c(0.975),na.rm=TRUE)))
  contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
  dev.off()
  ...
  par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
  image.plot(resid_time_array_unc[,,2], col=colour_choices, main=paste("Cwood residence time uncertainty",sep="")
            ,axes=FALSE, cex.main=2.4,legend.width=3.0,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1),zlim=c(0,quantile(as.vector(resid_time_array_unc[,,2]),prob=c(0.975),na.rm=TRUE)))
  contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
  dev.off()
  ...
  par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
  image.plot(resid_time_array_unc[,,3], col=colour_choices, main=paste("Croot residence time uncertainty",sep="")
  ...
  if (PROJECT$model$name == "DALEC_CDEA_LU_FIRES" | PROJECT$model$name == "DALEC_EVERGREEN" | PROJECT$model$name == "DALEC_GSI_DFOL_CWD_FR" 
    ...
    | PROJECT$model$name == "DALECN_BUCKET") {
      ...
      par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
      image.plot(resid_time_array_unc[,,5], col=colour_choices, main=paste("CDeadOrg residence time uncertainty",sep="")
                ,axes=FALSE, cex.main=2.4,legend.width=3.0,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1),zlim=c(0,quantile(as.vector(resid_time_array_unc[,,5]),prob=c(0.975),na.rm=TRUE)))
      contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
      dev.off()
  }
  # create histograms
  ...
  for (p in seq(1,dim(par_array_median)[3])) {
       ...
       par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
       image.plot(abs((par_array_unc[,,p]/par_array_median[,,p])*100), col=colour_choices, main=paste(par_names[p]," uncertainty range % of median",sep="")
                 ,axes=FALSE, cex.main=2.4,legend.width=3.0,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1))
       contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
       dev.off()
       ...
       par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
       image.plot(par_array_converged[,,p], col=colour_choices, main=paste(par_names[p]," Gelmen-Rubens convergence (1 = PASS / 0 = FALSE)",sep="")
  ...
  if (length(which(as.vector(pixel_initial_age_array) > 0))) {
      ...
      par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
      image.plot(pixel_initial_age_array, col=colour_choices, main="Initial age (Years)",axes=FALSE, cex.main=2.4,legend.width=3.0
                ,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1),zlim=c(0,max(as.vector(pixel_initial_age_array),na.rm=TRUE)))
      contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
      dev.off()
  }
  ...
  if (length(which(as.vector(pixel_yield_class_array) > 0))) {
      ...
      par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
      image.plot(pixel_yield_class_array, col=colour_choices, main="Yield Class (m3.yr-1)",axes=FALSE, cex.main=2.4
                ,legend.width=3.0,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1),zlim=c(0,max(as.vector(pixel_yield_class_array),na.rm=TRUE)))
      contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
      dev.off()
  }
  ...
  par(mfrow=c(1,1), mar=c(1.2, 1.0, 2.2, 6.3), omi=c(0.2, 0.2, 0.2, 0.40))
  image.plot(mean_precipitation_array, col=colour_choices, main="Mean precipitation (mm.yr-1)",axes=FALSE, cex.main=2.4,legend.width=3.0
            ,cex=1.5,axis.args=list(cex.axis=1.8,hadj=0.1),zlim=c(0,max(as.vector(mean_precipitation_array),na.rm=TRUE)))
  contour(landmask, add = TRUE, lwd=1.0, nlevels=1,axes=FALSE,drawlabels=FALSE,col="black")
  dev.off()
