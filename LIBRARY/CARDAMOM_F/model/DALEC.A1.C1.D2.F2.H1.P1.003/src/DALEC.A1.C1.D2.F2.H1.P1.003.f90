...
!    print*,"carbon_model: "
    ...
    ! Rooting parameters
    root_k = pars(25) ; max_depth = pars(26)
...
!    rfac = 0.5d0 ; rfac(5) = 0.1d0 ; rfac(6) = 0d0
    ...
    root_biomass = fine_root_biomass + max(min_root,POOLS(1,4)*pars(24)*2d0)
    ...
    do n = start, finish
       ...
       root_biomass = fine_root_biomass + max(min_root,POOLS(n,4)*pars(24)*2d0)
       call calculate_Rtot
