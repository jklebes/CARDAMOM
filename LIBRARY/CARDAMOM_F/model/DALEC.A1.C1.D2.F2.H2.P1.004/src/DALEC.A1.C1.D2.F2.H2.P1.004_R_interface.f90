...
!endif
     ...
     out_var1(i,1:nodays,57) = gs_demand_supply_ratio(1:nodays) ! ratio of evaporative demand over supply
     out_var1(i,1:nodays,58) = gs_total_canopy(1:nodays)   ! Canopy scale stomatal conductance during day light (mmolH2O/m2ground/s)
     out_var1(i,1:nodays,59) = canopy_par_MJday_time(1:nodays)  ! Canopy absorbed PAR (MJ/m2ground/day)
     out_var1(i,1:nodays,60) = gb_total_canopy(1:nodays)   ! Canopy scale aerodynamic conductance (mmolH2O/m2ground/s)
     out_var1(i,1:nodays,61) = cica_time(1:nodays)         ! ratio of leaf internal to external CO2
     ! misc
     out_var1(i,1:nodays,62) = root_depth_time(1:nodays)   ! rooting depth (m)
