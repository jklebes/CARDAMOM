...
! of DALEC.A1.C2.D2.F2.H2.P4.R2 as a function of observations and ecological dynamical constraints.
  !
...
!    endif
  ...
  subroutine assess_EDC2(npars,nomet,nofluxes,nopools,nodays,deltat &
    ...
    resid_lab = (M_FLUXES(:,8)+Rg_from_labile+Rm_from_labile+ &
...
!print*,"likelihood: Fire done"
    ...
    if (DATAin%otherpriors(5) > -9998) then
        ...
        output = sum(M_POOLS(:,4) / (M_FLUXES(:,11)+fire_emiss_wood+fire_litter_wood))
