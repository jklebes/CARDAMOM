...
!    rfac = 0.5d0 ; rfac(5) = 0.1d0 ; rfac(6) = 0d0
    ...
    do n = start, finish
       ...
       ! labile pool
       POOLS(n+1,1) = POOLS(n,1) + (FLUXES(n,5)-FLUXES(n,8)-FLUXES(n,50))*days_per_step
       ! foliar pool
       ...
       FLUXES(n,51) = infiltrated(2)  ! middle soil surface infiltration by rain (kgH2O/m2/day)
       FLUXES(n,52) = infiltrated(3)  ! bottom soil surface infiltration by rain (kgH2O/m2/day)
