# Quality Assessment for CARDAMOM

An automated assessment of the CARDAMOM tool based on the EVERSE software quality indicators, run on 2026-09-09.

## General Information

- **Software:** CARDAMOM
- **Repository:** https://github.com/jklebes/CARDAMOM
- **Assessment date:** 2026-09-09T11:24:59Z
- **Total checks:** 42
...
- **Evidence:** Could not find a title for the project in the repository
- **Suggestions:** A title would be of much help to describe your software. More information at https://everse.software/RSQKit/software_metadata
...
- **Evidence:** Workflows were found in:
	- https://raw.githubusercontent.com/jklebes/CARDAMOM/codemeta/.github/workflows/cmake-single-platform.yml
	- https://raw.githubusercontent.com/jklebes/CARDAMOM/codemeta/.github/workflows/rsmetacheck.yml
	- https://raw.githubusercontent.com/jklebes/CARDAMOM/codemeta/.github/workflows/fair_assessment.yml
	- https://raw.githubusercontent.com/jklebes/CARDAMOM/codemeta/.github/workflows/generate-codemeta.yml
- **Suggestions:** No suggestions
...
- **Evidence:** A citation was found in:
	- https://raw.githubusercontent.com/jklebes/CARDAMOM/codemeta/README.md
- **Suggestions:** No suggestions
...
- **Evidence:** A license was found in:
	- https://raw.githubusercontent.com/jklebes/CARDAMOM/codemeta/LICENSE
- **Suggestions:** No suggestions
...
- LIBRARY/CARDAMOM_F/general/MHMCMC_StressTests.f90	
- LIBRARY/CARDAMOM_F/general/Rscripts/include/testC.h	
- LIBRARY/CARDAMOM_F/general/Rscripts/load_stresstest.R	
- LIBRARY/CARDAMOM_F/general/Rscripts/stresstest_parallel_AM.R	
- LIBRARY/CARDAMOM_F/general/Rscripts/stresstest_parallel_DEzs.R	
- LIBRARY/CARDAMOM_F/general/Rscripts/stresstest_parallel_DEzs_b.R	
- LIBRARY/CARDAMOM_F/general/Rscripts/stresstest_serial.R	
- LIBRARY/CARDAMOM_F/general/Rscripts/testC.c	
- LIBRARY/CARDAMOM_F/misc/brent_zero/brent_test.f90	
- stress_test_output_COV	
- stress_test_output_COVINFO	
- stress_test_output_PARS	
- stress_test_output_STEP	
- test	
- test/CMakeLists.txt	
- test/cardamom_main_stresstest.f90	
- test/cmake	
- test/cmake/Findtest-drive.cmake	
- test/data	
- test/data/UK_baseline_sites_AliceHolt.bin	
- test/main.f90	
- test/model_likelihood_wrapper.f90	
- test/test_DEMCz.f90	
- test/test_MCMC.f90	
- test/test_carbon_model.f90	
- test/test_cardamom_MCMC.f90	
- test/test_common.f90	
- test/test_functions.f90	
- test/test_math.f90	
- test/test_model.f90	
- test/test_random.f90	
- test/test_suite1.f90	
- test/test_wrappers_for_R.f90
- **Suggestions:** No suggestions
