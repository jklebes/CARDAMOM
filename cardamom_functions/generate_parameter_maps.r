...
generate_parameter_maps<-function(PROJECT) {
	...
	if (file.exists(outfile) == FALSE | repair == 1) {
		...
		if (file.exists(loadfile) == TRUE) {
		    ...
		    if (PROJECT$model$name == "DALEC_GSI_DFOL_CWD_FR" | PROJECT$model$name == "DALEC_GSI_BUCKET" | PROJECT$model$name == "DALECN_GSI_BUCKET" | PROJECT$model$name == "DALECN_BUCKET" ) {
	...
	if (file.exists(outfile) == FALSE | repair == 1) {
		...
		| PROJECT$model$name == "DALEC_GSI_BUCKET" | PROJECT$model$name == "DALECN_GSI_BUCKET" | PROJECT$model$name == "DALECN_BUCKET" ) {
