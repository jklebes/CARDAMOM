...
! Subroutine to allow direct interface between DALEC.A1.C1.D2.F2.H1.P1 and the R code
!
...
!endif
     ...
     out_var1(i,1:nodays,6)  = FLUXES(1:nodays,29)      ! harvested material (gC/m2/day)
     ...
     out_var1(i,1:nodays,44) = gs_demand_supply_ratio   ! ratio of evaporative demand over supply
     out_var1(i,1:nodays,45) = gs_total_canopy          ! stomatal conductance (mmolH2O/m2ground/day)
     out_var1(i,1:nodays,46) = canopy_par_MJday_time    ! Canopy absorbed PAR (MJ/m2ground/day)
     out_var1(i,1:nodays,47) = gb_total_canopy          ! boundary conductance (mmolH2O/m2ground/day)
     out_var1(i,1:nodays,48) = cica_time                ! ratio of leaf internal to external CO2
