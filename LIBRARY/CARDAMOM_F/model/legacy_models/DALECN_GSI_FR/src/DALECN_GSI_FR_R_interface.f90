...
subroutine rdalecngsifr(output_dim,aNPP_dim,met,pars,out_var,out_var2,lat &
...
!endif
     ...
     out_var(i,1:nodays,18) = POOLS(1:nodays,7) ! CWD

     ! N related
     out_var(i,1:nodays,19) = POOLS(1:nodays,8) ! litter N
     out_var(i,1:nodays,20) = POOLS(1:nodays,10) ! labile N
     out_var(i,1:nodays,21) = POOLS(1:nodays,9) ! DIN
     out_var(i,1:nodays,22) = (FLUXES(1:nodays,14)*(1/pars(42,i))*(1d0-DON_leaching)) &
