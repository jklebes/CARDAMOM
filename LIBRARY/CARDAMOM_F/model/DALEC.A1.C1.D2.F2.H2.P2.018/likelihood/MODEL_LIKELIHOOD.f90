...
! of DALEC.A1.C1.D2.F2.H2.P2 as a function of observations and ecological dynamical constraints.
  !
...
!if (tot_exp /= sum(1d0-EDCD%PASSFAIL(1:EDCD%nedc))) stop "bollocks"
