...
! of DALEC.C3.M1 as a function of observations and ecological dynamical constraints.
!
...
!    endif
  ...
  subroutine assess_EDC2(npars,nomet,nofluxes,nopools,nodays,deltat &
    ...
    ! only do this for litter and Csom pool
    do n = 5, 6 !nopools
       if (EDC2 == 1 .or. DIAG == 1) then
          decay_coef = expdecay2(M_POOLS(1:(nodays+1),n),deltat,nodays+1)
  ...
  double precision function likelihood(npars,pars)
    use cardamom_structures, only: DATAin
    use carbon_model_mod, only: DS_time
