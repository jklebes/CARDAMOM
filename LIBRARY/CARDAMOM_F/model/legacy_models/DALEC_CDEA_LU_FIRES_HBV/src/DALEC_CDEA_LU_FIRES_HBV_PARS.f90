module MODEL_PARAMETERS
  ...
  subroutine pars_info
    ...
    ! water related parameters here
    ! LP: fraction of fc needed to have ETact = ETpot
    PI%parmin(24)=0.3
    PI%parmax(24)=1.
    ...
    ! BETA: beta is reference LAI for ETpot
    PI%parmin(26)=1.;
    PI%parmax(26)=6.;

    ! initial water storage as a fraction of field capacity
    PI%parmin(27)= 0.001;
    PI%parmax(27)= 1.;
