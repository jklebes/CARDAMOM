#include <math.h>
#include "EDCs.c"
#include "../src/DALEC_LU_FIRES_GSI.c" // model
#include "../src/DALEC_LU_FIRES_GSI_PARS.c" // parameter info
...
double likelihood(DATA D)
{
    ...
    // Biomass likelihood  // average annual biomass 
    tot_exp=0;
    if (D.nCabgb_stock>0)
...
//        for (n=0;n<D.nodays;n++)
        {
          ...
          //  printf("%d %d %f %f\n", n, dn, D.Cabgb_stock[dn],D.M_ABGB_ANN[n]);
//            dn=D.Cabgb_stockpts[n];
