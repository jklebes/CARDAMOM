...
|----------------------------------|---------------------|-----------------------------------------------------|-------------------------------|-----------|
| DALEC_A1C1D1F2H0P1R1             | DALEC_CDEA_LU_FIRES, C1, M1              | Fire model updated from F1 to F2| Bloom & Williams et al., 2015 | Published |
| DALEC_A2C1D2F2H1P1R1             | DALEC_CDEA_ACM2, C6, M2                  | Fire model updated from F1 to F2| Smallman et al., 2021.        | Published |
| DALEC_A2C1D2F2H2P1R1             | DALEC_CDEA_ACM2_BUCKET, C7, M3           | Fire model updated from F1 to F2| Smallman et al., 2021         | Published |
| DALEC_A2C1D2F2H2P1R2             | DALEC_CDEA_ACM2_BUCKET_RmRg, C10, M4     | Fire model updated from F1 to F2| Smallman et al., 2021         | Published |
| DALEC_A2C2D2F2H2P1R2             | DALEC_CDEA_ACM2_BUCKET_RmRg_CWD, C11, M5 | Fire model updated from F1 to F2| Smallman et al., 2021         | Published |
| DALEC_A2C2D2F2H2P2R2             | DALEC_CDEA_ACM2_BUCKET_RmRg_CWD_wMRT, C12| Fire model updated from F1 to F2| Smallman et al., 2021         | Published |
| DALEC_A2C2D2F2H1P3R1             | DALEC_GSI_DFOL_CWD_FR, G1                | Fire model updated from F1 to F2| Smallman et al., 2017         | Published |
| DALEC_A2C2D2F2H2P3R1             | DALEC_GSI_BUCKET, G2                     | Fire model updated from F1 to F2| Smallman et al., 2017         | Published |
...
| A3         | As A2 but with Farquhar equations | Unpublished |
...
| Model Name | Short Description                                                          | Details                   |
|------------|----------------------------------------------------------------------------|---------------------------|
| D1         | Foliage and wood removed as determined by input fractional loss, no litter residues | Published (Bloom & Williams 2015)  |
...
| P2         | Combined Deciduous Evergreen Analytical model. Uses a day of year based approach to canopy growth and loss. Fixed fraction for NPP allocation. 1st order kinetic for fine roots, with 1st order kinetics modified by a Michaelis-Menten function on wood turnover. | Published (Famiglietti et al., 2021)  |
| P3         | Growing Season Index (GSI) Canopy growth and mortality a linear function of daylength, temperature and vapour pressure deficit. Fixed fraction for NPP allocation and 1st order kinetic for non-foliage turnovers. | Published (Smallman et al., 2017)  |
...
| R2         | Maintenance respiration estimated as a parameterisable fixed fraction of photosynthesis, growth respiration is a hardcoded fraction of NPP. Heterotrophic respiration follows 1st order kinetics with exponential temperature modification | Published (Bloom & Williams et al., 2015)  |
